...
public class JdbcUtil {
	...
	public static final String DEFAULT_USER = "ian"; //CHANGE TO YOUR MYSQL USER NAME
	
	public static final String DEFAULT_PASSWOD = "ian"; // CHANGE TO YOUR MYSQL PASSWORD
